...
CITY_SQUARE_TEXTS = {
    "ridge": "Каменные стены Кряжа держат небо на копьях. Патрули Ордена проходят мимо не "
             "глядя; здесь это давно привычка, а не доверие.",
    "woods": "Пущи смыкаются над самой площадью, ветви сплетаются в подобие крыши. Пахнет "
             "мхом и дымом костров, и кто-то тихо напевает на языке, которого ты ещё не выучил.",
    "docks": "Солёный ветер несёт крики чаек и торговцев вперемешку. Доски площади скрипят "
             "под ногами: тут всё временное, кроме воды.",
    "scorched": "Пепел тут не грязь, а почва, по нему ходят как по брусчатке. Спирали шрамов "
                "мелькают на лицах прохожих, и никто не смотрит на них дважды.",
}

TAVERN_TEXTS = {
    "ridge": "В таверне пахнет элем и полировкой для доспехов. Разговоры тише, чем в других "
             "городах: Кряж не любит трепаться о делах Ордена.",
    "woods": "Здесь пьют настой из коры и молчат больше, чем говорят. Огонь в очаге горит зелёным.",
    "docks": "Пол шатается в такт волнам, будто таверна сама на плаву. Моряки делят стол с "
             "контрабандистами, и странным это никому не кажется.",
    "scorched": "Пепельная пыль оседает даже на кружках. Стоит кому-то помянуть раскол, "
                "разговор стихает.",
}

MARKET_QUARTER_TEXTS = {
    "ridge": "Ряды лотков тянутся вдоль стены: оружие, броня, слухи. Всё по одной цене, если "
             "знать, с кем говорить.",
    "woods": "Торговцы Пущи держат товар под навесами из живых веток. Здесь редко продают то, "
             "что не выросло само.",
    "docks": "Торгуют всем, что прибило волной или сняли с чужого корабля. Вопросов лучше не "
             "задавать.",
    "scorched": "Прилавки закопчены не хуже самих торговцев. Каждая сделка тут маленький "
