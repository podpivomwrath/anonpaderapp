...
class PeerScheduler:
    ...
    def schedule(self, peer_id: int, delay_seconds: float) -> None:
        ...
        self.scheduler.add_job(
            ...
            # Запас намеренно большой. При 30 секундах занятый на полминуты
            # цикл событий МОЛЧА выбрасывал задачу: прибытие/исследование/
            # поклёвка не наступали никогда, а игрок оставался с клавиатурой
            # ожидания и без единого сообщения. Лучше доставить событие
            # позже, чем не доставить вовсе.
