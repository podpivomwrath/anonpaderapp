...
def try_apply_control(
    ...
    # Попытку отмечаем ДО всех проверок: окну прерывания Хирурга важен сам
    # факт, что по нему ударили контролем, а не то, лёг ли эффект (патч 66).
    target.control_attempted_by.add(source_id)
