...
# --- Патч 26: ребаланс сложности мобов ---
...
# VIT — живучесть, остальные три — по крохам.
MOB_STAT_ALLOCATION = {"primary": 0.45, "vit": 0.30, "other": 0.0833}
...
# Базовый множитель статов моба (компенсирует экипировку/навыки/эликсиры/отдых
# игрока — у моба этого нет) + множитель по глубине кольца (дальше от
# Монолита — слабее; см. game.world.world_config.ZONE_TABLE).
MOB_BASE_MULTIPLIER = 1.25
