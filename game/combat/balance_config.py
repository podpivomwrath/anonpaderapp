...
BLOOD_KNIGHT_HEAL_CAP_PER_TURN = 0.15       # % от maxHP за ход — общий кап для всех навыков лайфстила
# Патч 63: поднят с 0.10. Кровавый рыцарь упирался в потолок раньше, чем
# успевал окупить свою же плату здоровьем, и весь его лайфстил сверх капа
# просто пропадал. «Вечный голод» даёт ПРИБАВКУ к этому числу, поэтому
# бонус баффа растёт вместе с базой и обесцениться не может.
